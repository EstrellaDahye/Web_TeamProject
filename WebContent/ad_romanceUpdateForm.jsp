...
<body>
	...
	<% 
		...
		if (session.getAttribute("id") != null) {
			...
			DirDataBean article = new DirDBBean_Ro().getmovieRo(movieID);
	%>
	<p class="inner-title">Movie Management</p>
	<div class="inner-body">
			<form method="post" action="ad_romanceUpdateAction.jsp?movieID=<%=movieID %>">
			<table class="table table-striped" style= "text-align :center; 
					border: 1px solid #dddddd">
			<thead>
					<tr>
						<th colspan="3" style="background-color: #eeeeee; 
							text-align: center;">UpdateMovie-Romance</th>
					</tr>
				</thead>
				<tbody>
					<tr>
